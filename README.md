...
```shell
docker pull kubernetesloong64/nexus3-loong64:3.96.0
```
...
docker run -d --name nexus \
  ...
  kubernetesloong64/nexus3-loong64:3.96.0
```
...
Push a branch named `loong64-<nexus-version>` (e.g. `loong64-3.96.0`) to trigger a build.

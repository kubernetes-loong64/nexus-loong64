...
```shell
docker pull kubernetesloong64/nexus3-loong64:3.95.2
```
...
docker run -d --name nexus \
  ...
  kubernetesloong64/nexus3-loong64:3.95.2
```
...
Push a branch named `loong64-<nexus-version>` (e.g. `loong64-3.95.2`) to trigger a build.
